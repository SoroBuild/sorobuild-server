...
SERVICE_NAME="sorobuild-server"
APP_DIR="/home/tinkerpal/sorobuild-server"
REPO_URL="git@github.com:SoroBuild/sorobuild-server.git"
...
ExecStartPre=$DOCKER_BIN build --no-cache -t sorobuild-server .
